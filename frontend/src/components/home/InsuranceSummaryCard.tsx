...
export function InsuranceSummaryCard({ summary }: Props) {
  ...
  return (
    <div>
      ...
      <ExpandableGridCard
        expanded={isExpanded}
        onToggle={() => cardExpand.toggle('insurance')}
        className={isExpanded ? 'ring-2 ring-teal-400 ring-offset-1 rounded-xl' : ''}
        collapsed={
          <div className="tap grid grid-cols-3 divide-x divide-teal-100 dark:divide-teal-900/40 rounded-xl border border-teal-100 bg-teal-50 dark:border-teal-900/40 dark:bg-teal-900/10 px-4 py-3">
            <div className="pr-4">
