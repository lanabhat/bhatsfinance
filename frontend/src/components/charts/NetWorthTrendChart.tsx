      ...
      <AreaChart data={data} margin={{ top: 10, right: 20, left: 0, bottom: 0 }}>
        <defs>
          <linearGradient id="nwGrad" x1="0" y1="0" x2="0" y2="1">
            <stop offset="5%" stopColor="#b4521f" stopOpacity={0.35} />
            <stop offset="95%" stopColor="#b4521f" stopOpacity={0} />
          </linearGradient>
        </defs>
        ...
        <Area type="monotone" dataKey="networth" name="Net Worth" stroke="#b4521f" fill="url(#nwGrad)" strokeWidth={2.5} dot={false} />
      </AreaChart>
    </ResponsiveContainer>
  )
}
